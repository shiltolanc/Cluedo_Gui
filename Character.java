...
public class Character {
    ...
    public void makeGuess(Board board) {
        ...
        characterGuessed = board.characters.get(characterChoice - 1);
        ...
        //board.characters.get(characterChoice - 1).setX((int)((estateGuessed.getX2()-estateGuessed.getX())/2+estateGuessed.getX()));
        //board.characters.get(characterChoice - 1).setY((int)((estateGuessed.getY2()-estateGuessed.getY())/2+estateGuessed.getY()));
